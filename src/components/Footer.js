        ...
        return (
            <div className="footer">
                ...
                <Typography className= "texto">Contatos: 
                 <a className="texto" target="_blank" href="https://api.whatsapp.com/send?phone=5588996704014&text=Ol%C3%A1%2C%20estou%20interessado%20nos%20seus%20servi%C3%A7os!"> <WhatsAppIcon /> </a>
